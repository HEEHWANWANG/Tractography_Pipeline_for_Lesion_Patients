...
parser.add_argument('--root_dir', type=str,
                    default='/scratch/connectome/dhkdgmlghks/lesion_tract_pipeline/lesion_tract/TransUNet_training/UNETR_code', help='root dir for data')
#                    default='/home/ubuntu/dhkdgmlghks/TransUNet/UNETR_code', help='root dir for data') 
...
if __name__ == "__main__":
    ...
    # setting UNETR 
    net = monai.networks.nets.UNETR(in_channels=1, out_channels=args.num_classes, img_size=256, spatial_dims=2, dropout_rate=0.3)
